...
#format percent_<candidate> to percent
    ...
    return [total_votes, votes_Khan, percent_Khan, votes_Correy, percent_Correy, votes_Li, percent_Li, votes_OTooley, percent_OTooley] #total, avg_change, max_month, max_revenue, min_month, min_revenue]
